...
subdep 'lib/NES/Header001.hs', 'lib/NES.hs';
subdep doths('soundtest'), 'lib/NES/ASoundEngine.hs';
subdep doths('controllertest'), [qw(lib/NES.hs lib/NES/Reservations.hs lib/NES/ImageLoader.hs controllertest/sprites.png controllertest/background.bin)];
subdep 'agame/Actors.hs', 'lib/NES/Reservations.hs';
subdep doths('agame'), [qw(agame/Actors.hs lib/NES/Reservations.hs lib/NES/Header001.hs agame/sprites.png agame/background.png)];
module 'soundtest';
