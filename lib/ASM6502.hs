...
op8or16 :: Integral x => String -> Word8 -> Word8 -> x -> ASM6502 ()
op8or16 name a b x = case fromIntegral (0x010101 `asTypeOf` x) of
    0x01 -> byte a >> byte (fromIntegral x)
    0x0101 -> byte b >> le16 (fromIntegral x)
...
(*->*) :: (Integral a, Integral b) => a -> b -> ASM6502 ()
...
(*<-*) :: (Integral a, Integral b) => b -> a -> ASM6502 ()
(*<-*) = flip (*->*)
(*<&-*) :: (Integral a, Integral b) => b -> a -> ASM6502 ()
(*<&-*) = flip (*-&>*)
(*<|-*) :: (Integral a, Integral b) => b -> a -> ASM6502 ()
